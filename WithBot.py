...
play1=[]
print("You ave choosen to Pla with a Bot")
play2=[]
play3=[]
play4=[]
...
for i in range(9):
    ...
    while(1):
        ...
        if(win(play2)):
            print("Player is weaker than a bot to win ")
            exit(0)
        if(full(play3)):
            print("Unforunately Both are competitive")
            exit(0)
